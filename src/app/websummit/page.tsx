...
export const metadata: Metadata = { title: "Web Summit | Matyas Fodor" };

export default function WebSummitPage() {
  return (
    <section>
      ...
      <p>
        ...
        tried to define what would be the ideal role for me. What I&apos;ve
        enjoyed the most is laying down the foundations of a product and
        building a tech team. I am looking for a similar opportunity, but I am
        open to talk about other opportunities as well.
      </p>
      ...
      <ul>
        <li>
          Vast startup experience—having worked with five different startups in
          the past decade, across different industries
        </li>
